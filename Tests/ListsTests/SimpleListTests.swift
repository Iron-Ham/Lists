...
struct SimpleListTests {
    ...
    @Test func setItemsWithEmptyArrayClears() async {
        let list = SimpleList<TextItem>()
    ...
    @Test func setItemsWithBuilder() async {
        let list = SimpleList<TextItem>()
