...
struct ListsPerformanceTests {
    // MARK: - DSL Snapshot Building Performance

    @Test func dslBuild100Sections100Items() {
    ...
    @Test func dslBuildSingleSection10kItems() {
    ...
    // MARK: - DSL Build vs Manual Build Comparison

    @Test func dslBuildPerformanceMatchesManual() {
        let itemCount = 10000
    ...
    @Test func fullPipelineBuildAndDiff10k() {
    ...
    @Test func fullPipelineMultiSectionBuildAndDiff() {
        let clock = ContinuousClock()
        let elapsed = clock.measure {
    ...
    // MARK: - SectionModel Pipeline

    @Test func sectionModelBuild10Sections1000Items() {
        let clock = ContinuousClock()
        let elapsed = clock.measure {
    ...
    // MARK: - Repeated Apply Simulation

    @Test func repeatedDiffsSimulatingScrollUpdates() {
    ...
    @Test func repeatedDiffsSimulatingShuffle() {
