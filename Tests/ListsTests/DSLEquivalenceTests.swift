...
// MARK: - DSLEquivalenceTests

struct DSLEquivalenceTests {
  @Test
  func dslProducesSameSnapshotAsManual() {
  ...
  @Test
  func dslWithConditionalsProducesCorrectSnapshot() {
    let showExtra = true
  ...
  @Test
  func dslWithLoopsProducesCorrectSnapshot() {
    let groups = ["A", "B", "C"]
    let itemsPerGroup = 5
  ...
  @Test
  func diffFromDSLSnapshotsMatchesDiffFromManualSnapshots() {
  ...
  @Test
  func dslSnapshotDiffProducesCorrectChangeset() {
  ...
  @Test
  func identifiableViewModelHashesByID() {
  ...
  @Test
  func identifiableViewModelWorksInSnapshot() {
    let items = [
