...
struct ReactiveCollectionsKitBenchmarks {
    // MARK: - Minimal CellViewModel for benchmarking
    ...
    struct BenchCell: CellViewModel {
        ...
        @MainActor func configure(cell _: UICollectionViewCell) {}
    ...
    // MARK: - Model Construction: Single Section

    @Test func modelConstruction10k() {
    ...
    @Test func modelConstruction50k() {
    ...
    // MARK: - Model Construction: Multiple Sections

    @Test func modelConstruction100Sections() {
    ...
    // MARK: - Type Erasure Overhead

    @Test func typeErasureOverhead10k() {
        let cells = (0 ..< 10000).map { i in
            BenchCell(id: AnyHashable(i), value: i)
        }
