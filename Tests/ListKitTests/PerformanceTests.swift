...
struct PerformanceTests {
    // MARK: - Heckel Diff Performance

    @Test func heckelDiff10kElements() {
    ...
    @Test func heckelDiff50kElements() {
    ...
    @Test func heckelDiff100kElements() {
    ...
    @Test func heckelDiffFullShuffle10k() {
        let old = Array(0 ..< 10000)
        var new = old
    ...
    @Test func heckelDiffNoChange10k() {
    ...
    // MARK: - Sectioned Diff Performance

    @Test func sectionedDiffSingleSection10kItems() {
    ...
    @Test func sectionedDiff100Sections100ItemsEach() {
    ...
    @Test func sectionedDiffSectionReorder() {
        var old = DiffableDataSourceSnapshot<Int, Int>()
        var new = DiffableDataSourceSnapshot<Int, Int>()
        var counter = 0
    ...
    @Test func sectionedDiffCrossSectionMoves() {
        var old = DiffableDataSourceSnapshot<String, Int>()
    ...
    // MARK: - Snapshot Building Performance

    @Test func snapshotBuildAndAppend10kItems() {
        let clock = ContinuousClock()
        let elapsed = clock.measure {
    ...
    @Test func snapshotBuildMultipleSections() {
        let clock = ContinuousClock()
        let elapsed = clock.measure {
    ...
    // MARK: - Scaling Verification (Linear Time)

    @Test func diffScalesLinearly() {
    ...
    @Test func diffWithManyDuplicates() {
    ...
    @Test func diffAlternatingInsertDelete() {
