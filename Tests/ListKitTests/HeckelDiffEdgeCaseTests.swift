...
struct HeckelDiffEdgeCaseTests {
  ...
  @Test
  func moveIndicesAreUniqueForLargeArray() {
  ...
  @Test
  func movingItemToFrontShiftsOthers() {
    let old = [1, 2, 3, 4, 5]
    let new = [5, 1, 2, 3, 4]
  ...
  @Test
  func moveWithSimultaneousInsert() {
    let old = [1, 2, 3]
    let new = [3, 1, 4, 2]
  ...
  @Test
  func moveWithSimultaneousDelete() {
    let old = [1, 2, 3, 4]
    let new = [4, 1, 3]
  ...
  @Test
  func duplicatesAtBoundariesUniqueInMiddle() {
    let old = [1, 2, 1]
    let new = [1, 2, 1]
  ...
  @Test
  func duplicatesWithUniqueElementMoving() {
    let old = [1, 1, 2, 1]
    let new = [2, 1, 1, 1]
  ...
  @Test
  func diffCoversAllIndicesForShuffle() {
    let old = Array(0 ..< 100)
