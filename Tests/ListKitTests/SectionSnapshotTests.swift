...
struct SectionSnapshotTests {
    ...
    @Test func insertBeforeAndAfter() {
        var snapshot = DiffableDataSourceSectionSnapshot<String>()
        snapshot.append(["A", "C"])
